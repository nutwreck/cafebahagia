...
$config['file'] 			= $config['assets'].'file/';
$config['bootstrap']		= $config['plugin'].'bootstrap-3.3.6/';
$config['font_awesome']		= $config['plugin'].'font-awesome/';

//Setingan Judul & Footer Web
$config['web_title']		= "Cafe Bahagia";
$config['web_footer']		= $config['web_title']." &copy; " . date('Y');

//Setingan informasi global
$config['no_list_data']     = "Data Kosong";
