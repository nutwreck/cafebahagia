...
<script type="text/javascript" language="javascript" >
	...
	$(document).on('click', '#HapusTransaksi', function(e){
		...
		var Check = "<br /><hr style='margin:10px 0px 8px 0px;' /><div class='checkbox'><label><input type='checkbox' name='reverse_stok' value='yes' id='reverse_stok'> Kembalikan stok produk</label></div>";
