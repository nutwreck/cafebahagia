...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Produk <i class='fa fa-angle-right fa-fw'></i> List Kategori Produk</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('produk/tambah-kategori')."' class='btn btn-default' id='TambahKategori'><i class='fa fa-plus fa-fw'></i> Tambah Kategori Produk</a>";
...
<script type="text/javascript" language="javascript" >
	...
	$(document).on('click', '#TambahKategori, #EditKategori', function(e){
		...
		{
			$('#ModalHeader').html('Tambah Kategori Produk');
		}
		if($(this).attr('id') == 'EditKategori')
		{
			$('#ModalHeader').html('Edit Kategori Produk');
		}
